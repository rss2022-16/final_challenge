...
class BlueDetector():
    ...
    Publishes to: /relative_blue_px (ConeLocationPixel) : the coordinates of the cone in the image frame (units are pixels).
    """
    def __init__(self):
        ...
        self.cone_pub = rospy.Publisher("/relative_blue_px", ConeLocationPixel, queue_size=10)
        self.detector_pub = rospy.Publisher("/car_wash_detector", Bool, queue_size=10)
    ...
    def image_callback(self, image_msg):
        ...
        #print (image.shape)
        #image = image[215:235, :, :] 
        bbox = cd_color_segmentation(image, None, "blue")
        ...
        if u != 0 or v!= 0:
            ...
            detected.data = False
        self.detector_pub.publish(detected)
