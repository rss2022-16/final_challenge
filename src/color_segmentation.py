...
def cd_color_segmentation(img, template, color_to_detect = "orange"):
    """
    ...
    if color_to_detect == "blue":
        color_min = np.array([90, 50, 70])
        color_max = np.array([128, 255, 255])
    elif color_to_detect == "orange":
        color_min = np.array([4, 150, 100])
